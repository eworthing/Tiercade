...
extension View {
    ...
    @ViewBuilder
    internal func applyTierListCreatorModal(app: AppState) -> some View {
        #if os(macOS)
    ...
    @ViewBuilder
    internal func applyAnalysisModal(app: AppState) -> some View {
        #if !os(tvOS)
        self.sheet(isPresented: Binding(
    ...
    @ViewBuilder
    internal func applyFocusContainedModals(app: AppState) -> some View {
        #if os(macOS)
        self
    ...
    @ViewBuilder
    internal func applyAnalyticsSidebarModal(app: AppState) -> some View {
        #if os(tvOS)
        self
            .fullScreenCover(isPresented: Binding(
    ...
    @ViewBuilder
    internal func applyThemeCreatorAndMoveModals(app: AppState) -> some View {
        #if os(macOS)
        self
            .sheet(isPresented: Binding(
    ...
    @ViewBuilder
    internal func applyDebugModals(app: AppState) -> some View {
        #if DEBUG
        self.sheet(isPresented: Binding(
