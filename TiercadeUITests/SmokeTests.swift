...
final class SmokeTests: XCTestCase {
    ...
    let afterURL = URL(fileURLWithPath: "/tmp").appendingPathComponent("tiercade_ui_after.png")
    ...
    XCTAssertTrue(quickRankOverlayExists || h2hFinishExists, "Expected one of the overlays to be visible after interaction")
    }
}
